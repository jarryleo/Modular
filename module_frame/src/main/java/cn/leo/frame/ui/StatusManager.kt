...
class StatusManager private constructor(private val mBuilder: Builder) :
    ...
    companion object {
        ...
        const val VIEW_STATUS_CONTENT = 0
        const val VIEW_STATUS_ERROR = 1
        const val VIEW_STATUS_EMPTY = 2
        const val VIEW_STATUS_LOADING = 3
    }
     ...
     */
    @ViewState
    var currentStatus = VIEW_STATUS_CONTENT
        private set
    ...
    class Builder(var mTarget: View) {
        ...
        var mOnClickListener: (statusManager: StatusManager, stateView: View) -> Unit = { _, _ -> }
        ...
        fun setRetryClickListener(listener: (statusManager: StatusManager, stateView: View) -> Unit): Builder {
    ...
    fun setRetryClickListener(listener: (statusManager: StatusManager, stateView: View) -> Unit): StatusManager {
    ...
    fun showLoading(): ViewHelper {
        ...
        setClick()
        currentStatus = VIEW_STATUS_LOADING
    ...
    fun showEmpty(): ViewHelper {
        ...
        setClick()
        currentStatus = VIEW_STATUS_EMPTY
        return ViewHelper(mBuilder.mReplace)
    }
    ...
    fun showError(): ViewHelper {
        ...
        setClick()
        currentStatus = VIEW_STATUS_ERROR
        return ViewHelper(mBuilder.mReplace)
    }
    ...
    fun showContent() {
        ...
        currentStatus = VIEW_STATUS_CONTENT
    }

    /**
     * 加载页布局资源id
     */
    fun loadingViewLayout(@LayoutRes layoutRes: Int): StatusManager {
     ...
     * 空页面布局资源id
     */
    fun emptyViewLayout(@LayoutRes layoutRes: Int): StatusManager {
     ...
     * 错误页面布局资源id
     */
    fun errorViewLayout(@LayoutRes layoutRes: Int): StatusManager {
    ...
    private fun getViewById(view: View?, @IdRes viewId: Int): View? {
    ...
    class ViewHelper(private val mView: View?) {
         ...
         * @param text   设置的文字
         */
        fun setText(@IdRes viewId: Int, text: CharSequence?): ViewHelper {
         ...
         * @param resId  设置的文字资源
         */
        fun setText(@IdRes viewId: Int, @StringRes resId: Int): ViewHelper {
            val view = findViewById<View>(viewId)
            if (view is TextView) {
                view.setText(resId)
            } else {
         ...
         * @param resId  资源id
         */
        fun setImageResource(@IdRes viewId: Int, @DrawableRes resId: Int): ViewHelper {
            val view = findViewById<View>(viewId)
         ...
         * @param resId  资源id
         */
        fun setBackgroundResource(@IdRes viewId: Int, @DrawableRes resId: Int): ViewHelper {
            val view = findViewById<View>(viewId)
        ...
        fun setOnClickListener(@IdRes viewId: Int, onClickListener: View.OnClickListener?): ViewHelper {
            val view = findViewById<View>(viewId)
