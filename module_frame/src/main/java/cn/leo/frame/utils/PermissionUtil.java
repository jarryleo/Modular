...
public class PermissionUtil {
    ...
    public interface RationaleResult extends Result{
    ...
    public static class FragmentCallback extends Fragment {
            ...
            if (mResult != null) {
                if (result) {
                    ...
                    if (SystemClock.elapsedRealtime() - mRequestTime < 300) {
                        ...
                        openSettingActivity(getString(R.string.base_permission_should_show_rationale, s));
                    } else {
        ...
        public void openSettingActivity(String message) {
            if(mResult instanceof RationaleResult){
                mResult.onFailed(mPermissions);
                return;
            }
        ...
        private void showMessageOKCancel(String message,
            ...
            new AlertDialog.Builder(getActivity())
                    ...
                    .setNegativeButton(getString(R.string.base_permission_dialog_denied), cancelListener)
                    .create()
                    .show();
        }
    }
    ...
    private void requestPermission() {
        ...
        if (mActivity.getSupportFragmentManager().findFragmentByTag(tag) == null) {
            throw new PermissionRequestException(mActivity.getString(R.string.base_permission_request_exception));
        }
...
/*            //如果用户点了不提示(或者同时申请多个权限)，我们主动提示用户
    ...
    public class PermissionRequestException extends RuntimeException {
        public PermissionRequestException(String s) {
            super(s);
        }
    }
}
